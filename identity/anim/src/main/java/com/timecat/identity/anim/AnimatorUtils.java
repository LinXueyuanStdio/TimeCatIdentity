package com.timecat.identity.anim;
...
public final class AnimatorUtils {
    ...
    public static void hideViewAnimator(final View view, long duration, Animator.AnimatorListener listener) {
        AnimatorSet set = new AnimatorSet();
        ObjectAnimator animator2 = ObjectAnimator.ofFloat(view,
                "scaleX", 1f, 0.0f);
    ...
    public static void hideViewAnimator(final View view, long duration) {
        hideViewAnimator(view, duration, new Animator.AnimatorListener() {
            @Override
            public void onAnimationStart(Animator animation) {
