...
public interface RouterHub {
    ...
    String MASTER_ManageSpaceActivity = MASTER + "/ManageSpaceActivity";
    String MASTER_NewSpaceActivity = MASTER + "/NewSpaceActivity";
    String MASTER_EditSpaceActivity = MASTER + "/EditSpaceActivity";
    ...
    String USER_AllItemIllustratedActivity = USER + "/AllItemIllustratedActivity";
    String USER_AllIdentityIllustratedActivity = USER + "/AllIdentityIllustratedActivity";
    String USER_AllActivityIllustratedActivity = USER + "/AllActivityIllustratedActivity";
    ...
    String GLOBAL_RecordContainerService = GLOBAL + "master" + SERVICE + "/RecordContainerServiceImpl";
    ...
    String CREATE_CreateService_BLOCK_TAG = GLOBAL + SERVICE + "CreateService_BLOCK_TAG";
    String CREATE_CreateService_BLOCK_TOPIC = GLOBAL + SERVICE + "CreateService_BLOCK_TOPIC";
    String CREATE_CreateService_BLOCK_MEDIA = GLOBAL + SERVICE + "CreateService_BLOCK_MEDIA";
    String CREATE_CreateService_BLOCK_LEADER_BOARD = GLOBAL + SERVICE + "CreateService_BLOCK_LEADER_BOARD";
    String CREATE_CreateService_BLOCK_APP = GLOBAL + SERVICE + "CreateService_BLOCK_APP";
    String CREATE_CreateService_BLOCK_COMMENT = GLOBAL + SERVICE + "CreateService_BLOCK_COMMENT";
    String CREATE_CreateService_BLOCK_RECOMMEND = GLOBAL + SERVICE + "CreateService_BLOCK_RECOMMEND";
    String CREATE_CreateService_BLOCK_CONVERSATION = GLOBAL + SERVICE + "CreateService_BLOCK_CONVERSATION";
    String CREATE_CreateService_BLOCK_CONTAINER = GLOBAL + SERVICE + "CreateService_BLOCK_CONTAINER";
    String CREATE_CreateService_BLOCK_ACTIVITY = GLOBAL + SERVICE + "CreateService_BLOCK_ACTIVITY";
    String CREATE_CreateService_BLOCK_FOCUS = GLOBAL + SERVICE + "CreateService_BLOCK_FOCUS";
    String CREATE_CreateService_BLOCK_PATH = GLOBAL + SERVICE + "CreateService_BLOCK_PATH";
    String CREATE_CreateService_BLOCK_TASK = GLOBAL + SERVICE + "CreateService_BLOCK_TASK";
    String CREATE_CreateService_BLOCK_MOMENT = GLOBAL + SERVICE + "CreateService_BLOCK_MOMENT";
    String CREATE_CreateService_BLOCK_DIALOG = GLOBAL + SERVICE + "CreateService_BLOCK_DIALOG";
    String CREATE_CreateService_BLOCK_PLUGIN = GLOBAL + SERVICE + "CreateService_BLOCK_PLUGIN";
    String CREATE_CreateService_BLOCK_LINK = GLOBAL + SERVICE + "CreateService_BLOCK_LINK";
    String CREATE_CreateService_BLOCK_BUTTON = GLOBAL + SERVICE + "CreateService_BLOCK_BUTTON";
    String CREATE_CreateService_BLOCK_FORUM = GLOBAL + SERVICE + "CreateService_BLOCK_FORUM";
    String CREATE_CreateService_BLOCK_POST = GLOBAL + SERVICE + "CreateService_BLOCK_POST";
    String CREATE_CreateService_BLOCK_PERMISSION = GLOBAL + SERVICE + "CreateService_BLOCK_PERMISSION";
    String CREATE_CreateService_BLOCK_IDENTITY = GLOBAL + SERVICE + "CreateService_BLOCK_IDENTITY";
    String CREATE_CreateService_BLOCK_ROLE = GLOBAL + SERVICE + "CreateService_BLOCK_ROLE";
    String CREATE_CreateService_BLOCK_ITEM = GLOBAL + SERVICE + "CreateService_BLOCK_ITEM";
    String CREATE_CreateService_BLOCK_MAIL = GLOBAL + SERVICE + "CreateService_BLOCK_MAIL";
    String CREATE_CreateService_BLOCK_SHOP = GLOBAL + SERVICE + "CreateService_BLOCK_SHOP";
    String CREATE_CreateService_BLOCK_SPACE = GLOBAL + SERVICE + "CreateService_BLOCK_SPACE";
    String CREATE_CreateService_BLOCK_SKIN = GLOBAL + SERVICE + "CreateService_BLOCK_SKIN";
    ...
    String CARD_CardService_BLOCK_TAG = GLOBAL + SERVICE + "CardService_BLOCK_TAG";
    String CARD_CardService_BLOCK_TOPIC = GLOBAL + SERVICE + "CardService_BLOCK_TOPIC";
    String CARD_CardService_BLOCK_MEDIA = GLOBAL + SERVICE + "CardService_BLOCK_MEDIA";
    String CARD_CardService_BLOCK_LEADER_BOARD = GLOBAL + SERVICE + "CardService_BLOCK_LEADER_BOARD";
    String CARD_CardService_BLOCK_APP = GLOBAL + SERVICE + "CardService_BLOCK_APP";
    String CARD_CardService_BLOCK_COMMENT = GLOBAL + SERVICE + "CardService_BLOCK_COMMENT";
    String CARD_CardService_BLOCK_RECOMMEND = GLOBAL + SERVICE + "CardService_BLOCK_RECOMMEND";
    String CARD_CardService_BLOCK_CONVERSATION = GLOBAL + SERVICE + "CardService_BLOCK_CONVERSATION";
    String CARD_CardService_BLOCK_CONTAINER = GLOBAL + SERVICE + "CardService_BLOCK_CONTAINER";
    String CARD_CardService_BLOCK_ACTIVITY = GLOBAL + SERVICE + "CardService_BLOCK_ACTIVITY";
    String CARD_CardService_BLOCK_FOCUS = GLOBAL + SERVICE + "CardService_BLOCK_FOCUS";
    String CARD_CardService_BLOCK_PATH = GLOBAL + SERVICE + "CardService_BLOCK_PATH";
    String CARD_CardService_BLOCK_TASK = GLOBAL + SERVICE + "CardService_BLOCK_TASK";
    String CARD_CardService_BLOCK_MOMENT = GLOBAL + SERVICE + "CardService_BLOCK_MOMENT";
    String CARD_CardService_BLOCK_DIALOG = GLOBAL + SERVICE + "CardService_BLOCK_DIALOG";
    String CARD_CardService_BLOCK_PLUGIN = GLOBAL + SERVICE + "CardService_BLOCK_PLUGIN";
    String CARD_CardService_BLOCK_LINK = GLOBAL + SERVICE + "CardService_BLOCK_LINK";
    String CARD_CardService_BLOCK_BUTTON = GLOBAL + SERVICE + "CardService_BLOCK_BUTTON";
    String CARD_CardService_BLOCK_FORUM = GLOBAL + SERVICE + "CardService_BLOCK_FORUM";
    String CARD_CardService_BLOCK_POST = GLOBAL + SERVICE + "CardService_BLOCK_POST";
    String CARD_CardService_BLOCK_PERMISSION = GLOBAL + SERVICE + "CardService_BLOCK_PERMISSION";
    String CARD_CardService_BLOCK_IDENTITY = GLOBAL + SERVICE + "CardService_BLOCK_IDENTITY";
    String CARD_CardService_BLOCK_ROLE = GLOBAL + SERVICE + "CardService_BLOCK_ROLE";
    String CARD_CardService_BLOCK_ITEM = GLOBAL + SERVICE + "CardService_BLOCK_ITEM";
    String CARD_CardService_BLOCK_MAIL = GLOBAL + SERVICE + "CardService_BLOCK_MAIL";
    String CARD_CardService_BLOCK_SHOP = GLOBAL + SERVICE + "CardService_BLOCK_SHOP";
    String CARD_CardService_BLOCK_SPACE = GLOBAL + SERVICE + "CardService_BLOCK_SPACE";
    String CARD_CardService_BLOCK_SKIN = GLOBAL + SERVICE + "CardService_BLOCK_SKIN";
    ...
    String NAVI_NaviService_BLOCK_TAG = GLOBAL + SERVICE + "NaviService_BLOCK_TAG";
    String NAVI_NaviService_BLOCK_TOPIC = GLOBAL + SERVICE + "NaviService_BLOCK_TOPIC";
    String NAVI_NaviService_BLOCK_MEDIA = GLOBAL + SERVICE + "NaviService_BLOCK_MEDIA";
    String NAVI_NaviService_BLOCK_LEADER_BOARD = GLOBAL + SERVICE + "NaviService_BLOCK_LEADER_BOARD";
    String NAVI_NaviService_BLOCK_APP = GLOBAL + SERVICE + "NaviService_BLOCK_APP";
    String NAVI_NaviService_BLOCK_COMMENT = GLOBAL + SERVICE + "NaviService_BLOCK_COMMENT";
    String NAVI_NaviService_BLOCK_RECOMMEND = GLOBAL + SERVICE + "NaviService_BLOCK_RECOMMEND";
    String NAVI_NaviService_BLOCK_CONVERSATION = GLOBAL + SERVICE + "NaviService_BLOCK_CONVERSATION";
    String NAVI_NaviService_BLOCK_CONTAINER = GLOBAL + SERVICE + "NaviService_BLOCK_CONTAINER";
    String NAVI_NaviService_BLOCK_ACTIVITY = GLOBAL + SERVICE + "NaviService_BLOCK_ACTIVITY";
    String NAVI_NaviService_BLOCK_FOCUS = GLOBAL + SERVICE + "NaviService_BLOCK_FOCUS";
    String NAVI_NaviService_BLOCK_PATH = GLOBAL + SERVICE + "NaviService_BLOCK_PATH";
    String NAVI_NaviService_BLOCK_TASK = GLOBAL + SERVICE + "NaviService_BLOCK_TASK";
    String NAVI_NaviService_BLOCK_MOMENT = GLOBAL + SERVICE + "NaviService_BLOCK_MOMENT";
    String NAVI_NaviService_BLOCK_DIALOG = GLOBAL + SERVICE + "NaviService_BLOCK_DIALOG";
    String NAVI_NaviService_BLOCK_PLUGIN = GLOBAL + SERVICE + "NaviService_BLOCK_PLUGIN";
    String NAVI_NaviService_BLOCK_LINK = GLOBAL + SERVICE + "NaviService_BLOCK_LINK";
    String NAVI_NaviService_BLOCK_BUTTON = GLOBAL + SERVICE + "NaviService_BLOCK_BUTTON";
    String NAVI_NaviService_BLOCK_FORUM = GLOBAL + SERVICE + "NaviService_BLOCK_FORUM";
    String NAVI_NaviService_BLOCK_POST = GLOBAL + SERVICE + "NaviService_BLOCK_POST";
    String NAVI_NaviService_BLOCK_PERMISSION = GLOBAL + SERVICE + "NaviService_BLOCK_PERMISSION";
    String NAVI_NaviService_BLOCK_IDENTITY = GLOBAL + SERVICE + "NaviService_BLOCK_IDENTITY";
    String NAVI_NaviService_BLOCK_ROLE = GLOBAL + SERVICE + "NaviService_BLOCK_ROLE";
    String NAVI_NaviService_BLOCK_ITEM = GLOBAL + SERVICE + "NaviService_BLOCK_ITEM";
    String NAVI_NaviService_BLOCK_MAIL = GLOBAL + SERVICE + "NaviService_BLOCK_MAIL";
    String NAVI_NaviService_BLOCK_SHOP = GLOBAL + SERVICE + "NaviService_BLOCK_SHOP";
    String NAVI_NaviService_BLOCK_SPACE = GLOBAL + SERVICE + "NaviService_BLOCK_SPACE";
    String NAVI_NaviService_BLOCK_SKIN = GLOBAL + SERVICE + "NaviService_BLOCK_SKIN";
    //endregion
